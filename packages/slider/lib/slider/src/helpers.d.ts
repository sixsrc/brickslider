...
export declare function animateElement(element: HTMLElement | HTMLElement[] | undefined, keyframes: Keyframe[], options: KeyframeAnimationOptions): Animation[];
...
export declare function listener(events: string[], target: EventTarget | undefined, callback: EventListenerOrEventListenerObject | ((event: any) => void), options?: boolean | AddEventListenerOptions): void;
export declare function removeListener(events: string[], target: EventTarget | undefined, callback: EventListenerOrEventListenerObject | ((event: any) => void), options?: boolean | EventListenerOptions): void;
