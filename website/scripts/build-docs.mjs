  ...
  if (src === "/examples/stories/") {
    ...
    <div class="doc-example-frame">
      <div class="relative">
        ...
        <div
          id="docs-stories-slider"
          class="hidden pointer-events-none fixed inset-0 z-[10000] flex select-none items-center justify-center p-6 max-md:p-0"
        >
          <div
            class="bs-track group/stories pointer-events-auto relative z-[10001] aspect-[9/16] h-[min(86vh,760px)] w-[min(92vw,calc(86vh*9/16),430px)] max-w-[min(92vw,430px)] overflow-hidden max-md:h-[100dvh] max-md:w-screen max-md:max-w-none"
          >
            <div class="bs-container h-full text-white">
              <div class="bs-slide h-full">
                ...
                >
                  <div
                    class="relative text-xs font-semibold uppercase tracking-[0.18em] opacity-80 md:mt-4"
                  >
                  ...
                  <span
                    class="relative mt-5 text-sm opacity-70 md:mt-4 md:text-xs"
              ...
              <div class="bs-slide h-full">
                ...
                >
                  ...
                  ></video>
                  <div
                    class="absolute inset-0 bg-gradient-to-t from-violet-950 via-violet-950/35 to-pink-500/20"
                  ></div>
                  <div class="relative max-w-[16rem]">
                    <span
                      class="mb-4 block text-sm uppercase tracking-[0.25em] opacity-80"
                    >
                      Video ready
                    </span>
                    <strong
                      class="block break-words text-[clamp(1.5rem,5.5vw,2.35rem)] font-bold leading-[0.98]"
                    >
                      Rio de Janeiro
                    </strong>
                  </div>
              ...
              <div class="bs-slide h-full">
                ...
                >
                  <span
                    class="relative text-xs font-semibold uppercase tracking-[0.18em] opacity-70 md:mt-4"
                    >Plugin API</span
                  >
                  <strong
                    class="relative mt-4 block max-w-[18rem] break-words text-[clamp(2.35rem,9.5vw,3.35rem)] font-bold leading-[0.98] md:max-w-[14rem] md:text-[clamp(1.5rem,3vw,1.95rem)] md:leading-[1.08]"
                  >
            ...
            >
              <span class="bs-stories-mute-on">
                ...
                >
                  <path
                    d="M4 9v6h4l5 4V5L8 9H4zm12.5 3a4.5 4.5 0 0 0-2.5-4.03v8.05A4.5 4.5 0 0 0 16.5 12zm-2.5-8.7v2.1A7.5 7.5 0 0 1 18.5 12a7.5 7.5 0 0 1-4.5 6.6v2.1A9.5 9.5 0 0 0 20.5 12 9.5 9.5 0 0 0 14 3.3z"
                  ></path>
                </svg>
              </span>
              <span class="bs-stories-mute-off hidden">
                ...
                >
                  <path
                    d="M4 9v6h4l5 4V5L8 9H4zm10.59 3L12 9.41 13.41 8 16 10.59 18.59 8 20 9.41 17.41 12 20 14.59 18.59 16 16 13.41 13.41 16 12 14.59 14.59 12z"
                  ></path>
                </svg>
              </span>
            </button>
            ...
            <ul
              class="bs-stories-progress pointer-events-auto absolute left-4 right-4 top-[calc(env(safe-area-inset-top)+12px)] z-[10003] flex list-none items-center gap-1 p-0 m-0 md:top-4"
            >
              <li
                class="bs-stories-progress-item h-1 flex-1 overflow-hidden rounded-full bg-white/20 [&.bs-stories-progress-item--active]:bg-white/35 [&.bs-stories-progress-item--completed]:bg-white/45"
              >
                <span
                  class="bs-stories-progress-bar block h-full w-full origin-left bg-white"
                ></span>
              </li>
            </ul>

            <button
              class="bs-stories-close pointer-events-auto absolute right-4 top-[6dvh] z-[10004] flex h-9 w-9 cursor-pointer items-center justify-center rounded-full bg-white/15 text-white transition-colors hover:bg-white/25 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:ring-offset-2 focus:ring-offset-violet-950 md:fixed md:right-6 md:top-8"
              type="button"
            ...
            <button
              class="bs-stories-pause-indicator pointer-events-none absolute left-1/2 top-1/2 z-[10004] hidden h-16 w-16 -translate-x-1/2 -translate-y-1/2 cursor-pointer items-center justify-center rounded-full bg-white/20 text-white opacity-0 transition-colors transition-opacity hover:bg-white/30 focus:outline-none focus:ring-2 focus:ring-violet-300 focus:ring-offset-2 focus:ring-offset-white md:flex"
              type="button"
        ...
        <div
          class="bs-stories-layer hidden pointer-events-auto fixed inset-0 select-none"
        >
          <div
            class="bs-stories-backdrop pointer-events-auto fixed inset-0 z-[9999] bg-violet-950/95"
          ></div>
        </div>
      </div>
      <script type="module">
        ...
        const docsStoriesSlider = new BrickSlider("#docs-stories-slider", {
          slidesPerView: 1,
          slidesPerPage: 1,
          useLoop: false
        })

        docsStoriesSlider.use(
          new StoriesPlugin({
            trigger: "#docs-open-stories",
            duration: 5000,
            maxStories: 10,
            closeOnEnd: false,
            pauseOnHover: true,
...
<html lang="en">
  <head>
    ...
    <link rel="canonical" href="https://brickslider.github.io${canonicalPath}" />
${legacyRedirect}
${devReloadScript}
    ...
    <style>
      ...
      .doc-example-frame { border: 0; border-radius: 0; overflow: visible; background: transparent; box-shadow: none; }
      .doc-example-frame iframe { display: block; width: 100%; border: 0; background: transparent; border-radius: 0; }
