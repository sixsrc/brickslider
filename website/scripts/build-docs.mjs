...
function renderHeader() {
  return `<header class="sticky top-0 z-50 border-b border-gray-200 bg-white/90 backdrop-blur">
      <div class="mx-auto flex min-h-[92px] max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <a href="/docs/" class="flex items-center gap-3 py-2">
        ...
        <div class="hidden items-center gap-5 text-sm font-medium md:flex">
          ...
          <a href="/docs/" class="topbar-link flex items-center gap-2">
            <svg class="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <a href="https://www.npmjs.com/package/@sixsrc/brick-slider" class="topbar-link flex items-center gap-2" target="_blank" rel="noreferrer">
            <svg class="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="currentColor">
          ...
          <a href="https://github.com/sponsors/malopestorres" class="topbar-link flex items-center gap-2" target="_blank" rel="noreferrer">
            <svg class="h-4 w-4" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="currentColor" style="color:#bf3989">
        ...
        <button
          ...
          data-open="false"
        >
          <svg class="docs-menu-open-icon h-6 w-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round">
            <path d="M5 7h14M5 12h14M5 17h14" />
          </svg>
          <svg class="docs-menu-close-icon hidden h-6 w-6" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round">
  ...
  return `<div class="docs-top-menu" data-docs-top-menu hidden>
      <nav class="grid gap-3 px-6 py-8 text-lg font-semibold">
        ...
        <a href="/docs/" class="topbar-link flex items-center gap-3 rounded-2xl px-4 py-3">
          <svg class="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2">
            <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
            <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
          </svg>
          <span>Docs</span>
        ...
        <a href="https://www.npmjs.com/package/@sixsrc/brick-slider" class="topbar-link flex items-center gap-3 rounded-2xl px-4 py-3" target="_blank" rel="noreferrer">
          <svg class="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="currentColor">
            <path d="M2 7.5v9h10v-6h5v6h5v-9H2z" />
          </svg>
          <span>npm</span>
        </a>
...
function renderMobileDocsNav(currentSlug) {
  return `<button
      ...
      data-docs-nav-open
    >
      <svg class="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" />
        <path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" />
      </svg>
    </button>
    <div class="docs-mobile-nav" data-docs-nav hidden>
      <div class="flex min-h-[92px] items-center justify-between border-b border-gray-200 px-4">
        ...
        <button
          ...
          data-docs-nav-close
        >
          <svg class="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round">
            <path d="M6 6l12 12M18 6 6 18" />
          </svg>
        </button>
      </div>
...
function arrowPrevSvg() {
  return `<svg viewBox="0 0 24 24" class="h-6 w-6" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6l-6 6 6 6"></path></svg>`
}

function arrowNextSvg() {
  return `<svg viewBox="0 0 24 24" class="h-6 w-6" aria-hidden="true" focusable="false" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 6l6 6-6 6"></path></svg>`
}
